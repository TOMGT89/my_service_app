...
const THEMES = {
    default: { id: 'default', name: 'Cinematic Gold', bg: 'bg-[#0a0a0f]', sidebar: 'bg-[#0d0d14]/95 backdrop-blur-2xl', card: 'bg-[#12121a]/80 backdrop-blur-lg', text: 'text-gray-400', border: 'border-amber-900/20', input: 'bg-[#0a0a0f] border-amber-900/30', button: 'bg-gradient-to-r from-amber-600 to-yellow-500 hover:from-amber-500 hover:to-yellow-400 text-black shadow-lg shadow-amber-900/30', activeTab: 'bg-gradient-to-r from-amber-600/20 to-transparent border-l-2 border-amber-500 text-amber-400', accent: 'text-amber-400', iconBg: 'bg-gradient-to-r from-amber-600 to-yellow-500', iconText: 'text-black', accentBorder: 'border-amber-500/30', glowShadow: 'shadow-amber-900/30', hoverBorder: 'hover:border-amber-500/30', accentLight: 'text-amber-100' },
    midnight: { id: 'midnight', name: 'Midnight Purple', bg: 'bg-[#08080d]', sidebar: 'bg-[#0c0c14]/95 backdrop-blur-2xl', card: 'bg-[#10101a]/80 backdrop-blur-lg', text: 'text-zinc-400', border: 'border-purple-900/20', input: 'bg-[#08080d] border-purple-900/30', button: 'bg-gradient-to-r from-purple-600 to-violet-500 hover:from-purple-500 hover:to-violet-400 text-white shadow-lg shadow-purple-900/30', activeTab: 'bg-gradient-to-r from-purple-600/20 to-transparent border-l-2 border-purple-500 text-purple-400', accent: 'text-purple-400', iconBg: 'bg-gradient-to-r from-purple-600 to-violet-500', iconText: 'text-white', accentBorder: 'border-purple-500/30', glowShadow: 'shadow-purple-900/30', hoverBorder: 'hover:border-purple-500/30', accentLight: 'text-purple-100' },
    forest: { id: 'forest', name: 'Forest Emerald', bg: 'bg-[#080d08]', sidebar: 'bg-[#0a120a]/95 backdrop-blur-2xl', card: 'bg-[#0f170f]/80 backdrop-blur-lg', text: 'text-stone-400', border: 'border-emerald-900/20', input: 'bg-[#080d08] border-emerald-900/30', button: 'bg-gradient-to-r from-emerald-600 to-green-500 hover:from-emerald-500 hover:to-green-400 text-white shadow-lg shadow-emerald-900/30', activeTab: 'bg-gradient-to-r from-emerald-600/20 to-transparent border-l-2 border-emerald-500 text-emerald-400', accent: 'text-emerald-400', iconBg: 'bg-gradient-to-r from-emerald-600 to-green-500', iconText: 'text-white', accentBorder: 'border-emerald-500/30', glowShadow: 'shadow-emerald-900/30', hoverBorder: 'hover:border-emerald-500/30', accentLight: 'text-emerald-100' },
    ocean: { id: 'ocean', name: 'Ocean Cyan', bg: 'bg-[#080a0d]', sidebar: 'bg-[#0a0e14]/95 backdrop-blur-2xl', card: 'bg-[#0f1520]/80 backdrop-blur-lg', text: 'text-neutral-400', border: 'border-cyan-900/20', input: 'bg-[#080a0d] border-cyan-900/30', button: 'bg-gradient-to-r from-cyan-600 to-blue-500 hover:from-cyan-500 hover:to-blue-400 text-white shadow-lg shadow-cyan-900/30', activeTab: 'bg-gradient-to-r from-cyan-600/20 to-transparent border-l-2 border-cyan-500 text-cyan-400', accent: 'text-cyan-400', iconBg: 'bg-gradient-to-r from-cyan-600 to-blue-500', iconText: 'text-white', accentBorder: 'border-cyan-500/30', glowShadow: 'shadow-cyan-900/30', hoverBorder: 'hover:border-cyan-500/30', accentLight: 'text-cyan-100' },
    sunset: { id: 'sunset', name: 'Sunset Orange', bg: 'bg-[#0d0808]', sidebar: 'bg-[#140a0a]/95 backdrop-blur-2xl', card: 'bg-[#1a0f0f]/80 backdrop-blur-lg', text: 'text-gray-400', border: 'border-orange-900/20', input: 'bg-[#0d0808] border-orange-900/30', button: 'bg-gradient-to-r from-orange-600 to-red-500 hover:from-orange-500 hover:to-red-400 text-white shadow-lg shadow-orange-900/30', activeTab: 'bg-gradient-to-r from-orange-600/20 to-transparent border-l-2 border-orange-500 text-orange-400', accent: 'text-orange-400', iconBg: 'bg-gradient-to-r from-orange-600 to-red-500', iconText: 'text-white', accentBorder: 'border-orange-500/30', glowShadow: 'shadow-orange-900/30', hoverBorder: 'hover:border-orange-500/30', accentLight: 'text-orange-100' }
};
        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                <h2 className="text-2xl font-bold text-white flex items-center gap-3">
                    <span className={`${t.iconBg} p-2 rounded-lg shadow-lg ${t.glowShadow}`}><Home size={20} className={t.iconText} /></span>
                    Διαχείριση Στόλου
                </h2>
                <div className="flex gap-3 w-full md:w-auto">
                    <div className="relative flex-1 md:w-64">
                        <Search className={`absolute left-3 top-1/2 -translate-y-1/2 ${t.accent}`} size={18} />
                        <input type="text" placeholder="Αναζήτηση..." value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} className={`w-full ${t.input} text-white pl-10 pr-4 py-2 rounded-lg focus:ring-2 focus:ring-opacity-50 outline-none uppercase transition-all`} autoComplete="off" />
                    </div>
                    <button onClick={(e) => { e.preventDefault(); setShowForm(!showForm); }} className={`${t.button} px-4 py-2 rounded-lg flex gap-2 items-center font-bold transition-all`}><Plus size={18} /> <span className="hidden md:inline">Νέα Εισαγωγή</span></button>
                </div>
            </div>
            <AnimatePresence>{showForm && (<motion.form initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: 'auto' }} exit={{ opacity: 0, height: 0 }} onSubmit={handleAdd} className={`${t.card} border ${t.border} p-4 rounded-xl grid grid-cols-1 md:grid-cols-2 gap-4 overflow-hidden shadow-2xl`}><input autoFocus placeholder="Πινακίδα (ΑΒΓ-1234)" value={newCar.plateNumber} onChange={e => handleNewCarInput('plateNumber', e.target.value.toUpperCase())} className={`${t.input} text-white p-3 rounded-lg w-full font-bold uppercase tracking-wider`} autoComplete="off" /><div className="grid grid-cols-2 gap-2"><input placeholder="Μάρκα" value={newCar.brand} onChange={e => handleNewCarInput('brand', e.target.value)} className={`${t.input} text-white p-3 rounded-lg`} autoComplete="off" /><input placeholder="Μοντέλο" value={newCar.model} onChange={e => handleNewCarInput('model', e.target.value)} className={`${t.input} text-white p-3 rounded-lg`} autoComplete="off" /></div><input placeholder="Ονοματεπώνυμο Πελάτη" value={newCar.ownerName} onChange={e => handleNewCarInput('ownerName', e.target.value)} className={`${t.input} text-white p-3 rounded-lg`} autoComplete="name" /><input placeholder="Τηλέφωνο Επικοινωνίας" value={newCar.ownerPhone} onChange={e => handleNewCarInput('ownerPhone', e.target.value)} className={`${t.input} text-white p-3 rounded-lg`} autoComplete="tel" /><button type="submit" className="col-span-1 md:col-span-2 bg-gradient-to-r from-emerald-600 to-green-500 text-white p-3 rounded-lg font-bold hover:from-emerald-500 hover:to-green-400 shadow-lg shadow-emerald-900/30 mt-2 transition-all">Αποθήκευση Οχήματος</button></motion.form>)}</AnimatePresence>
            ...
            <div className="flex flex-col gap-4">
                {filteredVehicles.length === 0 ? (<p className="text-gray-500 text-center py-10">Δεν βρέθηκαν οχήματα.</p>) : (
                    filteredVehicles.map((car) => {
                        ...
                        return (
                            <motion.div key={car._id} className={`${t.card} border ${t.border} ${t.hoverBorder} p-0 rounded-xl flex flex-col md:flex-row overflow-hidden transition-all shadow-xl shadow-black/30`}>
                                {/* 1. CAR INFO (LEFT) */}
                                <div className={`p-4 ${t.sidebar} md:w-64 flex flex-col justify-center border-b md:border-b-0 md:border-r ${t.border}`}>
                                    <div className="flex items-center gap-3 mb-2">
                                        <div className={`${t.iconBg} p-2 rounded-lg shadow-lg ${t.glowShadow}`}><Wrench size={20} className={t.iconText} /></div>
                                        <h3 className={`text-xl font-bold ${t.accentLight} tracking-wider`}>{car.plateNumber}</h3>
                                    </div>
                                    <p className="text-gray-400 text-sm font-medium">{car.brand} {car.model}</p>
                                    <div className={`mt-3 pt-3 border-t ${t.border} flex flex-col gap-1 text-xs text-gray-500`}>
                                        <span className="flex items-center gap-2"><User size={12} className={t.accent} /> {car.ownerName || '-'}</span>
                                        <span className="flex items-center gap-2"><Phone size={12} className={t.accent} /> {car.ownerPhone || '-'}</span>
                                    </div>
                                </div>
        ...
        <ErrorBoundary>
            <div className={`min-h-screen ${theme?.bg || 'bg-slate-900'} text-white flex transition-colors duration-300 relative`}>
                ...
                <div className={`w-20 lg:w-64 ${theme?.sidebar || 'bg-[#0d0d14]/95 backdrop-blur-2xl'} flex flex-col items-center lg:items-stretch py-6 border-r ${theme?.border || 'border-amber-900/20'} shadow-[5px_0_30px_rgba(0,0,0,0.5)]`}>
                    ...
                    <div className={`px-2 space-y-2 border-t ${theme?.border || 'border-amber-900/20'} pt-4`}>
                        <button onClick={() => setShowAppQR(true)} className={`w-full p-3 rounded-xl flex items-center justify-center lg:justify-start gap-3 transition-all text-gray-400 hover:bg-white/5 ${theme?.accent ? `hover:${theme.accent}` : 'hover:text-amber-300'}`}><Smartphone size={20} /> <span className="hidden lg:inline font-bold">Mobile App</span></button>
                        <button onClick={() => setActiveTab('settings')} className={`w-full p-3 rounded-xl flex items-center justify-center lg:justify-start gap-3 transition-all ${activeTab === 'settings' ? theme?.activeTab : `text-gray-400 hover:bg-white/5 ${theme?.accent ? `hover:${theme.accent}` : 'hover:text-amber-300'}`}`}><Settings size={20} /> <span className="hidden lg:inline font-bold">Ρυθμίσεις</span></button>
